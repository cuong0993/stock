...
private fun fillRow(date: ZonedDateTime, barSeries: BaseBarSeries, xssfWorkbook: XSSFWorkbook) {
    ...
    val bar = barSeries.getBar(index)
    if (bar.volume >= DecimalNum.valueOf(5000) &&
        bar.closePrice > DecimalNum.valueOf(2) &&
        bar.closePrice < DecimalNum.valueOf(500)
    ) {
