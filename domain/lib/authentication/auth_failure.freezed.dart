...
class _$AuthFailureTearOff {
  ...
  AuthFailureCancelledByUser cancelledByUser() {
    return const AuthFailureCancelledByUser();
  }

  AuthFailureServerError serverError() {
    return const AuthFailureServerError();
  }
}
